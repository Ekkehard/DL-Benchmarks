...
% Comment out next line to turn Engineering Report into an article
...
\else
  ...
  \begin{document}
  \revision{A2}
  \revisiondescription{Moved code to github}
...
coverage of Deep Learning networks.  The code for all of these benchmarking
applications can be found in github under \verb|Ekkehard/DL-Benchmarks|.
